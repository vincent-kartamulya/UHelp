    ...
    <div id="upper-white-line" class="md:flex md:justify-between">
            ...
            <form method="POST" action="" enctype="multipart/form-data">
                <div class="event-title flex flex-col">
                    ...
                    <div class="flex flex-row w-[28vw]">
                        ...
                        <button class="text-[0.75vw] px-5 ml-[1vw] bg-yellow-new rounded-lg text-white shadow-lg">SUBSCRIBE </button>
                    </div>
                </div>
            </form>
        </div>
        ...
        <div class="grid gap-8 sm:gap-6 sm:grid-cols-2">
            <div class="w-[16vw]">
                ...
                <ul class="text-white font-medium text-[0.85vw]">
                    <div id="youtube-account" class="flex flex-row">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            class="h-[1.04vw] w-[1.04vw] mr-[0.3vw]"
                            fill="currentColor"
                            viewBox="0 0 24 24">
                            <path
