    ...
    <form class="w-[12%] z-10" action="">
        ...
        <div id="dropdownHover" class="z-10 hidden bg-[#FFD272] rounded-lg shadow w-[9.167vw]">
            <ul class="py-[0.208vw] text-[0.938vw] text-gray-700" aria-labelledby="dropdownHoverButton">
                <li>
                    <a href="#" class="block px-[0.833vw] py-[0.417vw] hover:bg-yellow-new hover:text-white">None</a>
                </li>
                <li>
                    <a href="#" class="block px-[0.833vw] py-[0.417vw] hover:bg-yellow-new hover:text-white">Latest</a>
                </li>
                <li>
                    <a href="#" class="block px-[0.833vw] py-[0.417vw] hover:bg-yellow-new hover:text-white">Earliest</a>
                </li>
            </ul>
        </div>
<<<<<<< HEAD
    ...
    <form action="">
        <div class="absolute flex inset-0 justify-end">
            <button class="flex justify-center bg-yellow-new hover:bg-yellow-hover w-[9.167vw] h-auto my-[0.417vw] rounded-full shadow-lg items-center">
                ...
                <p class="text-dark-blue-new text-[0.938vw] font-bold pl-[0.208vw]">Add Event</p>
            </button>
        </div>
    </form>
</div>
        ...
        <a href="#">
            <div class="relative h-[11.667vw] flex flex-row rounded-[1.25vw] bg-white shadow-2xl hover:scale-[1.02] transition duration-100 ease-in-out">
                ...
                <button data-modal-target="popup-modal" data-modal-toggle="popup-modal" type="button">
                    <svg class="absolute right-[1.250vw] bottom-[1.250vw]" xmlns="http://www.w3.org/2000/svg" width="1.458vw" height="1.458vw" viewBox="0 0 24 24">
...
>>>>>>> a1a46480368b0cfdd5d7df154db575a53e0d9a08
                </button>
            </div>
        </a>
        @endforeach
...
{{-- <div id="empty-search" class="flex justify-center my-[8vw]">
    <p class="text-[1.458vw] font-semibold text-dark-blue-new text-opacity-60">Your search for "..." is not found.</p>
</div> --}}
>>>>>>> a1a46480368b0cfdd5d7df154db575a53e0d9a08
