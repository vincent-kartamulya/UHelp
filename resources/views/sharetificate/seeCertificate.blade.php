...
@section('content')
<div id="before-blue-line" class="flex flex-col pt-[3.25vw]">
    <div class="flex flex-row items-center justify-center mb-[1.25vw]">
        ...
        <img class="ml-[1.042vw] w-[4vw] items-center justify-center" src="/assets/sharetificate/verified.svg" alt="Certificate Verified">
    </div>
    <div>
        <img class="w-4/5 m-auto" src="/assets/sharetificate/divider-blue.svg" alt="Divider Blue">
    </div>
</div>
<div id="after-blue-line" class="flex flex-col justify-center items-center gap-[5vw] mb-[5vw] mt-[3vw] md:flex-row sm:flex-row">
    <div id="left-content" class="items-center flex flex-col">
        <img class="shadow-xl w-[35vw]" src="/assets/sharetificate/certificate.png" alt="certificate">
        <a href="/seeCertificate/download">
            <div id="download-button" class="shadow-lg w-[12vw] h-[3vw] mt-[2.5vw] bg-yellow-new hover:bg-yellow-hover rounded-[2vw] justify-center items-center flex flex-row">
    ...
    <div id="right-content" class="flex flex-col justify-center w-[30vw] h-[28vw] bg-white border border-yellow-new shadow-shadow-custom rounded-[0.5vw] px-[2.5vw] py-[2.5vw] text-[1.3vw] text-dark-blue-new">
        <div>
