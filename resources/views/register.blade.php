...
<div class="w-full flex bg-slate-100">
    <div class="w-1/2 m-auto">
        <img class="m-auto mt-[1.042vw] w-[10vw] animate-bounce" src="/assets/logo-full.svg" alt="U-Help Logo">
        <div class="flex justify-center my-[2vw]">
            <div class=" w-7/12 h-auto bg-white rounded-[0.833vw] shadow-2xl px-[2vw] py-[1.5vw]">
                <form action="/SignUp/Verif" method="POST">
                    ...
                    <div class="flex items-center justify-between mb-[2vw]">
                        ...
                        <a href="/login" class="text-green-new text-[1.042vw] hover:underline">Login</a>
                    </div>
                    <div class="mb-[1vw]">
                    ...
                    <div class="mb-[0.5vw]">
                        ...
                        <input name="VerifyPassword" type="password" id="password" class="bg-gray-50 border border-yellow-new text-dark-blue-new text-[0.938vw] rounded-[0.417vw] focus:ring-yellow-new focus:border-yellow-new block w-full p-[0.521vw] h-[2.5vw]" placeholder="Confirm password">
                        @error('VerifyPassword')
                            <p class="text-red-500 text-[0.938vw] mt-[0.2vw]">{{$message}}</p>
                        @enderror
                    </div>
                    <button type="submit" class="flex justify-center w-full bg-yellow-new hover:bg-yellow-hover h-[2.083vw] mt-[2vw] mb-[1vw] rounded-[0.625vw] shadow-shadow-custom items-center text-dark-blue-new text-[0.938vw] font-semibold transition duration-100 ease-in-out">
                        Register
                    </button>
                    ...
                    <a href="{{route('google.login')}}" class="flex justify-center bg-white hover:bg-gray-100 h-[2.083vw] mt-[1vw] mb-[1vw] rounded-[0.625vw] shadow-shadow-custom items-center text-dark-blue-new text-[0.938vw] font-semibold transition duration-100 ease-in-out">
