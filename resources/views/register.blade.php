...
<div class="w-full flex bg-slate-100">
    <div class="w-1/2 m-auto">
        <img class="m-auto mt-5 w-[10vw]" src="/assets/logo-full.svg" alt="U-Help Logo">
        <div class="flex justify-center my-[2vw]">
            <div class=" w-7/12 h-auto bg-white rounded-2xl shadow-2xl px-[2vw] py-[1.5vw]">
                <form action="#">
                    <h2 class="text-dark-blue-new font-semibold text-[1.458vw] mb-[0.25vw]">Register</h2>
                    <div class="flex items-center mb-[1vw]">
                        <h2 class="text-[1vw] mr-[0.5vw]">Already have an account?</h2>
                        <a class="text-green-new text-[1vw] hover:underline" href="/login">Login</a>
                    </div>
                    <a href="#" class="flex justify-center bg-white hover:bg-gray-100 h-[2.083vw] mt-[1vw] mb-[2vw] rounded-[0.625vw] shadow-shadow-custom items-center text-dark-blue-new text-[0.938vw] font-semibold">
                    ...
                    <div class="mb-[1vw]">
                        ...
                        <input type="text" id="default-input" class="bg-gray-50 border border-gray-300 text-dark-blue-new text-[0.938vw] rounded-lg focus:ring-yellow-new focus:border-yellow-new block w-full p-[0.521vw]">
                        <p class="text-red-500 text-[0.8333vw] mt-[0.2vw]">Email already registered.</p>
                    </div>
                    <div class="mb-[1vw]">
                        <label for="password" class="block font-medium text-[1.042vw] text-dark-blue-new mb-[0.5vw]">Password</label>
                        <input type="password" id="password" class="bg-gray-50 border border-gray-300 text-dark-blue-new text-[0.938vw] rounded-lg focus:ring-yellow-new focus:border-yellow-new block w-full p-[0.521vw]">
                        <p class="text-red-500 text-[0.8333vw] mt-[0.2vw]">Password too easy to guess!</p>
                    </div>
                    <div class="mb-[0.5vw]">
                        <label for="password" class="block font-medium text-[1.042vw] text-dark-blue-new mb-[0.5vw]">Confirm Password</label>
                        <input type="password" id="password" class="bg-gray-50 border border-gray-300 text-dark-blue-new text-[0.938vw] rounded-lg focus:ring-yellow-new focus:border-yellow-new block w-full p-[0.521vw]">
                        <p class="text-red-500 text-[0.8333vw] mt-[0.2vw]">Password doesn't match!</p>
                    </div>
    ...
    <div class="w-1/2 h-screen">
        <img class="h-full w-full" src="/assets/register-element.gif" alt="Register">
    </div>
</div>
@endsection
