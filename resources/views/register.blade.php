        ...
        <div class="flex justify-center my-[2vw]">
            <div class=" w-7/12 h-auto bg-white rounded-2xl shadow-2xl px-[2vw] py-[1.5vw]">
                <form action="/SignUp/Verif" method="POST">
                    ...
                    <a href="{{route('google.login')}}" class="flex justify-center bg-white hover:bg-gray-100 h-[2.083vw] mt-[1vw] mb-[1vw] rounded-[0.625vw] shadow-shadow-custom items-center text-dark-blue-new text-[0.938vw] font-semibold">
