...
<div class="w-full flex bg-slate-100">
    ...
    <div class="w-1/2 m-auto">
        <img class="m-auto w-[10vw]" src="/assets/logo-full.svg" alt="U-Help Logo">
            ...
            <div class=" w-7/12 h-auto bg-white rounded-2xl shadow-2xl px-[2vw] py-[1.5vw]">
                <form action="#">
                    <div class="flex items-center justify-between mb-[2vw]">
                        ...
                        <a class="text-green-new text-[0.938vw] hover:underline" href="#">Register</a>
                    </div>
                    <div class="mb-[1vw]">
                        ...
                        <p class="text-red-500 text-[0.8333vw] mt-[0.2vw]">Email is not registered.</p>
                    </div>
                    <div class="mb-[0.5vw]">
                        ...
                        <p class="text-red-500 text-[0.8333vw] mt-[0.2vw]">Password is incorrect!</p>
                    </div>
