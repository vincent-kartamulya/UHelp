...
<div id="history" class="absolute z-10 h-full w-[40vw] m-auto bg-white border-l-[0.5vw] border-yellow-new shadow sm:p-[1.25vw] md:p-[2.5vw] mb-[3vw] right-[0vw]">
    <div id="text">
        <label for="destination-title" class=" mt-[5vw] mb-[2vw] text-center block font-semibold text-[2.5vw] text-[#3F487F]">History</label>
    </div>

    <div id="card-template-1" class="flex flex-row w-full m-auto bg-green-new rounded-[2vw] shadow sm:p-[1.25vw] md:p-[2vw] mb-[3vw]">
        <div id="left-destinationTimeDay">
            <div id="text">
                <label for="destination-title" class="block mb-[0.75vw] font-bold text-[1.5vw] text-white">Anggrek - Grand Indonesia</label>
                <h5 class="mb-[0.75vw] font-semibold text-[1vw] text-white">16:30 - 18:15</h5>
                <h5 class="font-semibold text-[1vw] text-white">Today, 6 April 2023</h5>
            </div>
        </div>

        <div id="right-bookedText">
            <h5 id="booked-text" class="mt-[4.5vw] ml-[3vw] font-semibold text-[1.5vw] text-yellow-new">
                Booked
            </h5>
        </div>
    </div>
    ...
    <div id="card-template-2" class="flex flex-row w-full m-auto bg-green-new rounded-[2vw] shadow sm:p-[1.25vw] md:p-[2vw] mb-[3vw]">
        <div id="left-destinationTimeDay">
            <div id="text">
                <label for="destination-title" class="block mb-[0.75vw] font-bold text-[1.5vw] text-white">Wisma Asia - Madura</label>
                <h5 class="mb-[0.75vw] font-semibold text-[1vw] text-white">7:00 - 8:00</h5>
                <h5 class="font-semibold text-[1vw] text-white">Today, 6 April 2023</h5>
            </div>
        </div>

        <div id="right-bookedText">
            <h5 id="booked-text" class="mt-[4.5vw] ml-[7vw] font-semibold text-[1.5vw] text-yellow-new">
                Booked
            </h5>
        </div>
    </div>
...
<div id="content" class="pt-[5vw] blur-[0.1vw]">
    ...
    <div id="card-template-1" class="flex flex-row w-1/2 m-auto bg-yellow-new rounded-[2vw] shadow sm:p-[1.25vw] md:p-[2.5vw] mb-[3vw]">
        <div id="left-destinationTimeDayIcon">
            ...
            <div id="schedule" class="inline-flex rounded-md shadow-sm text-[#539064] font-semibold text-[1vw]" role="group">
                <a class="py-1 w-[3vw] h-[2vw] text-center bg-white border-[0.15vw] border-[#539064] rounded-lg shadow hover:bg-[#539064] hover:text-white mr-[1vw]">Mon</a>
                <a class="py-1 w-[3vw] h-[2vw] text-center bg-white border-[0.15vw] border-[#539064] rounded-lg shadow hover:bg-[#539064] hover:text-white mr-[1vw]">Tue</a>
                <a class="py-1 w-[3vw] h-[2vw] text-center bg-white border-[0.15vw] border-[#539064] rounded-lg shadow hover:bg-[#539064] hover:text-white mr-[1vw]">Wed</a>
                <a class="py-1 w-[3vw] h-[2vw] text-center bg-white border-[0.15vw] border-[#539064] rounded-lg shadow hover:bg-[#539064] hover:text-white mr-[1vw]">Thr</a>
                <a class="py-1 w-[3vw] h-[2vw] text-center bg-white border-[0.15vw] border-[#539064] rounded-lg shadow hover:bg-[#539064] hover:text-white mr-[1vw]">Fri</a>
                <a class="py-1 w-[3vw] h-[2vw] text-center bg-white border-[0.15vw] border-[#539064] rounded-lg shadow hover:bg-[#539064] hover:text-white mr-[1vw]">Sat</a>
            </div>
        </div>
